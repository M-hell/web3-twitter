...
export default function App() {
  ...
  async function getTweets() {
    ...
    try {
      const tempTweets = await contract.methods.getAllTweetsFromAllOwners().call();
  
      // Convert BigInts to numbers where necessary
      ...
      {!loading && account && profileExists ? (
        <>
          <AddTweet
            ...
            getTweets={getTweets}
          />
          <Tweets tweets={tweets} shortAddress={shortAddress} contract={contract} account={account} />
        </>
      ) : (
        account &&
        !loading && (
